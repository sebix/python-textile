...
** Fix autolink urls with image references ("#17":../../issues/17)
** fix textile links containing parentheses ("#20":../../issues/17)
** fix double-encoding of code blocks ("#21":../../issues/17)
** fix handling of scheme in self-linked URLs ("#16":../../issues/17)
